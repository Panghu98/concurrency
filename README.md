# 多线程以及高并发的处理方案
## 总体的学习路线
![并发编程学习路线](https://github.com/Panghu98/concurrency/src/main/resources/pictures/并发编程学习路线.png)
## 关于多线程和高并发
...
![](https://github.com/Panghu98/concurrency/src/main/resources/pictures/HashMap.png)
HashMap的底层结构
* 由数组和链表组成
* 数组的长度必须为2的N次方
...
![](https://github.com/Panghu98/concurrency/src/main/resources/pictures/HashMap2.png)
